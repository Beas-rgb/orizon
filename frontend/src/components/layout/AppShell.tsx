    ...
    painel === "consultora"
      ? [
          ...
          },
          {
            title: "Consultoria",
            items: [
              { icon: iconMap.Users, label: "Equipe / convites", active: active === "equipe" },
              { icon: iconMap.FileText, label: "Pesquisas", active: active === "pesquisas" },
              { icon: iconMap.Archive, label: "Biblioteca", active: active === "biblioteca" },
              { icon: iconMap.BarChart2, label: "Resultados", active: active === "resultados" },
            ],
          },
          {
            title: "Conta",
            items: [
              { icon: iconMap.Settings, label: "Configurações", active: active === "config" },
              { icon: iconMap.HelpCircle, label: "Suporte" },
            ],
          },
        ]
      : painel === "orgao"
        ? [
            {
              ...
              items: [
                ...
                { icon: iconMap.BarChart2, label: "Resultados", active: active === "resultados" },
                { icon: iconMap.Archive, label: "Documentos", active: active === "biblioteca" },
              ],
            },
          ]
        : painel === "funcionario"
          ? [
              {
                ...
                items: [
                  ...
                  { icon: iconMap.ClipboardList, label: "Responder", active: active === "responder" },
                  { icon: iconMap.TrendingUp, label: "Minha nota", active: active === "nota" },
                ],
              },
            ]
          : [
